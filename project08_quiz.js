...
const quiz_options = [
    {
        question: "1. A …………………. array is one in which the elements not have contiguous indexes starting at 0.",
        answer: "sparse",
        options: ["special", "sparse", "heterogeneous", "dense"],
    },
    {
        question: "2. If the array is ………………, the value of the length property is greater than  the number of elements.",
        answer: "sparse",
        options: ["special", "sparse", "heterogeneous", "dense"],
    },
    {
        question: "3. The length property specifies the number of elements in the …………….. array in JavaScript.",
        answer: "dense",
        options: ["special", "sparse", "heterogeneous", "dense"],
    },
    {
        question: "4. If an array with five elements a=[1,2,3,4,5]; what will do the expression a.length=0 ",
    ...
    {
        question: "5. In ECMAScript 5, allows you to make the length property of an array read only with ………….",
    ...
    {
        question: "6. Which of the following is the correct expression to make length property of an array read only.",
    ...
    {
        question: "7. Which of the following method can’t be used to add array elements in JavaScript.",
        answer: "shift( )",
...
async function quizOptionPrompt(message, options) {
